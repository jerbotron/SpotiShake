...
public class OUBottomNavigationMenuView extends BottomNavigationMenuView {
    ...
    public OUBottomNavigationMenuView(Context context) {
        this(context, null);
    }

    public OUBottomNavigationMenuView(Context context, AttributeSet attrs) {
        super(context, attrs);

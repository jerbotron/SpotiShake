...
public class OUBottomNavigationView extends FrameLayout {
    ...
    public OUBottomNavigationView(Context context) {
        this(context, null);
    }

    public OUBottomNavigationView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public OUBottomNavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mMenuView = new OUBottomNavigationMenuView(context);

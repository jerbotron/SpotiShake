package com.jerbotron_mac.spotisave.receivers;
...
import com.jerbotron_mac.spotisave.services.IdNowService;
...
public class IdNowWidgetProvider extends AppWidgetProvider {
	...
	private static final String LOGTAG = "IdNowWidgetProvider";
	
	
	@Override
	public void onUpdate(Context receiver_context, AppWidgetManager in_appWidgetManager, int[] appWidgetIds) {
	...
	static void initViews(Context in_context){
	 ...
	 public static GracenoteMusicIDWidget getGnMusicIdInstance(Context newContext){
